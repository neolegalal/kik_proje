...
FACTORY_DIR = STATE / "production_data_factory" / "507_data_factory_monitor"
MODULE_ID = "507"
MODULE_NAME = "Data Factory Monitor"
...
def analyze(payload):
    ...
    decision='DATA FACTORY MONITOR READY' if not validation.get('errors') else 'DATA FACTORY MONITOR REVIEW'
...
def main():
    ...
    ts=now_stamp(); output=FACTORY_DIR/('507_data_factory_monitor.json'); state=FACTORY_DIR/('507_data_factory_monitor_state_'+ts+'.json'); report=REPORTS/('507_data_factory_monitor_raporu_'+ts+'.txt')
