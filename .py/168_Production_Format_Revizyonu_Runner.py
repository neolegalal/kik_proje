# -*- coding: utf-8 -*-
"""
168 - PRODUCTION FORMAT REVISION RUNNER
...
- 30-100 kelime aralığında olmalı.

5) sonuc
- Geriye dönük uyumluluk alanıdır.
- sonuc_ozeti ile aynı metni veya onun daha kısa halini yaz.
...
def normalize_result(obj, fallback_karar_no):
    ...
    for k in kartlar:
        ...
        # Geriye dönük uyumluluk: sonuc boşsa sonuc_ozeti ile doldur; sonuc_ozeti boşsa sonuc ile doldur.
        if not sonuc and sonuc_ozeti:
            sonuc = sonuc_ozeti
        if not sonuc_ozeti and sonuc:
            sonuc_ozeti = sonuc
...
def main():
    print("=" * 80)
    print("168 - PRODUCTION FORMAT REVISION RUNNER")
    print("=" * 80)
    ...
    with open(rapor_path, "w", encoding="utf-8") as f:
        f.write("168 - PRODUCTION FORMAT REVISION RUNNER RAPORU\n")
        f.write("=" * 80 + "\n\n")
