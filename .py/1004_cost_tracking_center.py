...
MODULE_DIR = STATE / "production_operations" / "1004_cost_tracking_center"
MODULE_ID = "1004"
MODULE_NAME = "Cost Tracking Center"
...
def main():
    ...
    decision='COST TRACKING CENTER READY' if not val['errors'] else 'COST TRACKING CENTER BLOCKED'
    ...
    ts=now_stamp(); output=MODULE_DIR/('1004_cost_tracking_center.json'); state=MODULE_DIR/('1004_cost_tracking_center_state_'+ts+'.json'); report=REPORTS/('1004_cost_tracking_center_raporu_'+ts+'.txt')
