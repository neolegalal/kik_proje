import argparse
from modules.neolegal_ai_runtime_decision_engine.engine import NeolegalAiRuntimeDecisionEngineModule
def main():
    ...
    res=NeolegalAiRuntimeDecisionEngineModule().run(); r=res['result']
    print('='*80); print('307.8 NeoLegal AI Runtime Decision Engine'.upper()+' TAMAMLANDI'); print('='*80)
