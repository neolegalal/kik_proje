import argparse
from modules.neolegal_ai_runtime_auditor.engine import NeolegalAiRuntimeAuditorModule
def main():
    ...
    res=NeolegalAiRuntimeAuditorModule().run(); r=res['result']
    print('='*80); print('307.9 NeoLegal AI Runtime Auditor'.upper()+' TAMAMLANDI'); print('='*80)
