import argparse
from modules.neolegal_ai_runtime_planner.engine import NeolegalAiRuntimePlannerModule
def main():
    ...
    res=NeolegalAiRuntimePlannerModule().run(); r=res['result']
    print('='*80); print('307.4 NeoLegal AI Runtime Planner'.upper()+' TAMAMLANDI'); print('='*80)
