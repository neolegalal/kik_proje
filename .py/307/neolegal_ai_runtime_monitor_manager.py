import argparse
from modules.neolegal_ai_runtime_monitor.engine import NeolegalAiRuntimeMonitorModule
def main():
    ...
    res=NeolegalAiRuntimeMonitorModule().run(); r=res['result']
    print('='*80); print('307.6 NeoLegal AI Runtime Monitor'.upper()+' TAMAMLANDI'); print('='*80)
