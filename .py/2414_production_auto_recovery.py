...
MODULE_DIR=BASE/"production_state"/"live_production_engine"/"2414_production_auto_recovery"
...
def main():
    ...
    decision="PRODUCTION AUTO RECOVERY READY" if not v["errors"] else "PRODUCTION AUTO RECOVERY BLOCKED"
