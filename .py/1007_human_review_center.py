...
MODULE_DIR = STATE / "production_operations" / "1007_human_review_center"
MODULE_ID = "1007"
MODULE_NAME = "Human Review Center"
...
def main():
    ...
    decision='HUMAN REVIEW CENTER READY' if not val['errors'] else 'HUMAN REVIEW CENTER BLOCKED'
    ...
    ts=now_stamp(); output=MODULE_DIR/('1007_human_review_center.json'); state=MODULE_DIR/('1007_human_review_center_state_'+ts+'.json'); report=REPORTS/('1007_human_review_center_raporu_'+ts+'.txt')
