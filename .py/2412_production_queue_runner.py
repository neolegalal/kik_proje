...
MODULE_DIR=BASE/"production_state"/"live_production_engine"/"2412_production_queue_runner"
...
def main():
    ...
    decision="PRODUCTION QUEUE RUNNER READY" if not v["errors"] else "PRODUCTION QUEUE RUNNER BLOCKED"
