...
MODULE_DIR = SCHEDULER_DIR / "206_5_retry_scheduler"
OUTPUT_FILE = MODULE_DIR / "206_5_retry_scheduler.json"

class RetrySchedulerModule:
    def __init__(self):
        self.sdk = SchedulerSDK(name="206.5 Retry Scheduler")

    def analyze(self, context, decision):
        return {
            "module_id": "206.5",
            "module_name": "Retry Scheduler",
    ...
    def run(self):
        ...
        result = {
            ...
            "decision": "RETRY SCHEDULER READY",
            "risk": decision.get("risk"),
            "recommendation": decision.get("reason")
        }

        payload = {
            "module": "206.5 Retry Scheduler",
            "created_at": now_text(),
            "analysis": analysis,
            "result": result,
        ...
        state = STATE_DIR / f"206_5_retry_scheduler_state_{ts}.json"
        report = REPORT_DIR / f"206_5_retry_scheduler_raporu_{ts}.txt"
