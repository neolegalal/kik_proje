...
MODULE_DIR = SCHEDULER_DIR / "206_7_batch_planner"
OUTPUT_FILE = MODULE_DIR / "206_7_batch_planner.json"

class BatchPlannerModule:
    def __init__(self):
        self.sdk = SchedulerSDK(name="206.7 Batch Planner")

    def analyze(self, context, decision):
        return {
            "module_id": "206.7",
            "module_name": "Batch Planner",
    ...
    def run(self):
        ...
        state = STATE_DIR / f"206_7_batch_planner_state_{ts}.json"
        report = REPORT_DIR / f"206_7_batch_planner_raporu_{ts}.txt"
