...
MODULE_DIR = SCHEDULER_DIR / "206_2_job_planner"
OUTPUT_FILE = MODULE_DIR / "206_2_job_planner.json"

class JobPlannerModule:
    def __init__(self):
        self.sdk = SchedulerSDK(name="206.2 Job Planner")

    def analyze(self, context, decision):
        return {
            "module_id": "206.2",
            "module_name": "Job Planner",
    ...
    def run(self):
        ...
        result = {
            ...
            "decision": "JOB PLANNER READY",
            "risk": decision.get("risk"),
            "recommendation": decision.get("reason")
        }

        payload = {
            "module": "206.2 Job Planner",
            "created_at": now_text(),
            "analysis": analysis,
            "result": result,
        ...
        state = STATE_DIR / f"206_2_job_planner_state_{ts}.json"
        report = REPORT_DIR / f"206_2_job_planner_raporu_{ts}.txt"
