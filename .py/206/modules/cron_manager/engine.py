...
MODULE_DIR = SCHEDULER_DIR / "206_6_cron_manager"
OUTPUT_FILE = MODULE_DIR / "206_6_cron_manager.json"

class CronManagerModule:
    def __init__(self):
        self.sdk = SchedulerSDK(name="206.6 Cron Manager")
    ...
    def run(self):
        ...
        state = STATE_DIR / f"206_6_cron_manager_state_{ts}.json"
        report = REPORT_DIR / f"206_6_cron_manager_raporu_{ts}.txt"
