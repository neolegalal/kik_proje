...
MODULE_DIR = SCHEDULER_DIR / "206_8_scheduler_dashboard"
OUTPUT_FILE = MODULE_DIR / "206_8_scheduler_dashboard.json"

class SchedulerDashboardModule:
    def __init__(self):
        self.sdk = SchedulerSDK(name="206.8 Scheduler Dashboard")

    def analyze(self, context, decision):
        return {
            "module_id": "206.8",
            "module_name": "Scheduler Dashboard",
    ...
    def run(self):
        ...
        result = {
            ...
            "decision": "SCHEDULER DASHBOARD READY",
            "risk": decision.get("risk"),
            "recommendation": decision.get("reason")
        }

        payload = {
            "module": "206.8 Scheduler Dashboard",
            "created_at": now_text(),
            "analysis": analysis,
            "result": result,
        ...
        state = STATE_DIR / f"206_8_scheduler_dashboard_state_{ts}.json"
        report = REPORT_DIR / f"206_8_scheduler_dashboard_raporu_{ts}.txt"
        ...
        lines = [
            "=" * 80,
            "206.8 Scheduler Dashboard".upper(),
            "=" * 80,
