...
MODULE_DIR = STATE / "production_operations" / "1003_batch_execution_manager"
MODULE_ID = "1003"
MODULE_NAME = "Batch Execution Manager"
...
def main():
    ...
    decision='BATCH EXECUTION MANAGER READY' if not val['errors'] else 'BATCH EXECUTION MANAGER BLOCKED'
    ...
    ts=now_stamp(); output=MODULE_DIR/('1003_batch_execution_manager.json'); state=MODULE_DIR/('1003_batch_execution_manager_state_'+ts+'.json'); report=REPORTS/('1003_batch_execution_manager_raporu_'+ts+'.txt')
