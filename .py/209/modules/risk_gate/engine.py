...
MODULE_DIR = AUTONOMOUS_DIR / "209_3_risk_gate"
OUTPUT_FILE = MODULE_DIR / "209_3_risk_gate.json"

class RiskGateModule:
    def __init__(self):
        self.sdk = AutonomousSDK(name="209.3 Risk Gate")

    def analyze(self, context, plan):
        return {
            "module_id": "209.3",
            "module_name": "Risk Gate",
    ...
    def run(self):
        ...
        result = {
            ...
            "decision": "RISK GATE READY" if not validation["errors"] else "RISK GATE REVIEW",
        ...
        state = STATE_DIR / f"209_3_risk_gate_state_{ts}.json"
        report = REPORT_DIR / f"209_3_risk_gate_raporu_{ts}.txt"
