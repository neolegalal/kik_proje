...
MODULE_DIR = AUTONOMOUS_DIR / "209_2_policy_engine"
OUTPUT_FILE = MODULE_DIR / "209_2_policy_engine.json"

class PolicyEngineModule:
    def __init__(self):
        self.sdk = AutonomousSDK(name="209.2 Policy Engine")
    ...
    def run(self):
        ...
        result = {
            ...
            "decision": "POLICY ENGINE READY" if not validation["errors"] else "POLICY ENGINE REVIEW",
        ...
        state = STATE_DIR / f"209_2_policy_engine_state_{ts}.json"
        report = REPORT_DIR / f"209_2_policy_engine_raporu_{ts}.txt"
