...
MODULE_DIR = STATE / "production_operations" / "1008_live_production_dashboard"
MODULE_ID = "1008"
MODULE_NAME = "Live Production Dashboard"
...
def main():
    ...
    decision='LIVE PRODUCTION DASHBOARD READY' if not val['errors'] else 'LIVE PRODUCTION DASHBOARD BLOCKED'
    ...
    ts=now_stamp(); output=MODULE_DIR/('1008_live_production_dashboard.json'); state=MODULE_DIR/('1008_live_production_dashboard_state_'+ts+'.json'); report=REPORTS/('1008_live_production_dashboard_raporu_'+ts+'.txt')
