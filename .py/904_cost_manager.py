...
MODULE_DIR = STATE / "production_master" / "904_cost_manager"
MODULE_ID = "904"
MODULE_NAME = "Cost Manager"
...
def main():
    ...
    score=val['score']; decision='COST MANAGER READY' if not val['errors'] else 'COST MANAGER BLOCKED'
    ...
    ts=now_stamp(); output=MODULE_DIR/('904_cost_manager.json'); state=MODULE_DIR/('904_cost_manager_state_'+ts+'.json'); report=REPORTS/('904_cost_manager_raporu_'+ts+'.txt')
