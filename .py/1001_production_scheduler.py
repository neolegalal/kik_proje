...
MODULE_DIR = STATE / "production_operations" / "1001_production_scheduler"
MODULE_ID = "1001"
MODULE_NAME = "Production Scheduler"
...
def main():
    ...
    decision='PRODUCTION SCHEDULER READY' if not val['errors'] else 'PRODUCTION SCHEDULER BLOCKED'
    ...
    ts=now_stamp(); output=MODULE_DIR/('1001_production_scheduler.json'); state=MODULE_DIR/('1001_production_scheduler_state_'+ts+'.json'); report=REPORTS/('1001_production_scheduler_raporu_'+ts+'.txt')
