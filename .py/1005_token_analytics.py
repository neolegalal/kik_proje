...
MODULE_DIR = STATE / "production_operations" / "1005_token_analytics"
MODULE_ID = "1005"
...
def main():
    ...
    decision='TOKEN ANALYTICS READY' if not val['errors'] else 'TOKEN ANALYTICS BLOCKED'
    ...
    ts=now_stamp(); output=MODULE_DIR/('1005_token_analytics.json'); state=MODULE_DIR/('1005_token_analytics_state_'+ts+'.json'); report=REPORTS/('1005_token_analytics_raporu_'+ts+'.txt')
