...
MODULE_DIR = STATE / "production_operations" / "1009_production_kpi_center"
MODULE_ID = "1009"
MODULE_NAME = "Production KPI Center"
...
def main():
    ...
    decision='PRODUCTION KPI CENTER READY' if not val['errors'] else 'PRODUCTION KPI CENTER BLOCKED'
    ...
    ts=now_stamp(); output=MODULE_DIR/('1009_production_kpi_center.json'); state=MODULE_DIR/('1009_production_kpi_center_state_'+ts+'.json'); report=REPORTS/('1009_production_kpi_center_raporu_'+ts+'.txt')
