...
MODULE_DIR=BASE/"production_state"/"live_production_engine"/"2420_live_production_certificate"
...
def main():
    ...
    decision="LIVE PRODUCTION CERTIFICATE READY" if not v["errors"] else "LIVE PRODUCTION CERTIFICATE BLOCKED"
