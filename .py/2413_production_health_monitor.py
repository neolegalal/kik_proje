...
MODULE_DIR=BASE/"production_state"/"live_production_engine"/"2413_production_health_monitor"
...
def main():
    ...
    decision="PRODUCTION HEALTH MONITOR READY" if not v["errors"] else "PRODUCTION HEALTH MONITOR BLOCKED"
