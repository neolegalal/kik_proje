...
MODULE_DIR=BASE/"production_state"/"live_production_engine"/"2417_production_cost_optimizer"
...
def main():
    ...
    decision="PRODUCTION COST OPTIMIZER READY" if not v["errors"] else "PRODUCTION COST OPTIMIZER BLOCKED"
