...
AUDIT_DIR = STATE / "production_readiness" / '314_api_integration_validator'
MODULE_ID = '314'
MODULE_NAME = 'API Integration Validator'
VERSION = 'v2.21'
TAG = 'v2.21-api-integration-validator'
MUST_HAVE = ['218', '307', '308']
PATTERNS = ['api', 'runtime', 'gateway', 'rag', 'export']
...
def create_docs():
    ...
    release_path = RELEASES / 'v2.21-api-integration-validator.md'
...
def main():
    ...
    ts = now_stamp()
    state_path = AUDIT_DIR / (MODULE_ID + "_api_integration_validator_audit_" + ts + ".json")
    report_path = REPORTS / (MODULE_ID + "_api_integration_validator_raporu_" + ts + ".txt")
