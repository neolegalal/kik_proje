...
MODULE_DIR = EXECUTION_DIR / "207_10_execution_auditor"
OUTPUT_FILE = MODULE_DIR / "207_10_execution_auditor.json"

class ExecutionAuditorModule:
    def __init__(self):
        self.sdk = ExecutionSDK(name="207.10 Execution Auditor")

    def analyze(self, context, plan):
        return {
            "module_id": "207.10",
            "module_name": "Execution Auditor",
    ...
    def run(self):
        ...
        result = {
            ...
            "decision": "EXECUTION AUDITOR READY" if not validation["errors"] else "EXECUTION AUDITOR REVIEW",
            "risk": context.get("scheduler_risk"),
            "recommendation": plan.get("message")
        }

        payload = {
            "module": "207.10 Execution Auditor",
            "created_at": now_text(),
            "analysis": analysis,
            "result": result,
        ...
        state = STATE_DIR / f"207_10_execution_auditor_state_{ts}.json"
        report = REPORT_DIR / f"207_10_execution_auditor_raporu_{ts}.txt"
        ...
        lines = [
            "=" * 80,
            "207.10 Execution Auditor".upper(),
            "=" * 80,
