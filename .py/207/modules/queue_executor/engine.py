...
MODULE_DIR = EXECUTION_DIR / "207_3_queue_executor"
OUTPUT_FILE = MODULE_DIR / "207_3_queue_executor.json"

class QueueExecutorModule:
    def __init__(self):
        self.sdk = ExecutionSDK(name="207.3 Queue Executor")

    def analyze(self, context, plan):
        return {
            "module_id": "207.3",
            "module_name": "Queue Executor",
    ...
    def run(self):
        ...
        result = {
            ...
            "decision": "QUEUE EXECUTOR READY" if not validation["errors"] else "QUEUE EXECUTOR REVIEW",
        ...
        state = STATE_DIR / f"207_3_queue_executor_state_{ts}.json"
        report = REPORT_DIR / f"207_3_queue_executor_raporu_{ts}.txt"
