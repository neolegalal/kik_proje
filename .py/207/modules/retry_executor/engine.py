...
MODULE_DIR = EXECUTION_DIR / "207_4_retry_executor"
OUTPUT_FILE = MODULE_DIR / "207_4_retry_executor.json"

class RetryExecutorModule:
    def __init__(self):
        self.sdk = ExecutionSDK(name="207.4 Retry Executor")

    def analyze(self, context, plan):
        return {
            "module_id": "207.4",
            "module_name": "Retry Executor",
    ...
    def run(self):
        ...
        result = {
            ...
            "decision": "RETRY EXECUTOR READY" if not validation["errors"] else "RETRY EXECUTOR REVIEW",
        ...
        state = STATE_DIR / f"207_4_retry_executor_state_{ts}.json"
        report = REPORT_DIR / f"207_4_retry_executor_raporu_{ts}.txt"
