...
MODULE_DIR = STATE / "production_master" / "906_live_dashboard"
MODULE_ID = "906"
MODULE_NAME = "Live Dashboard"
...
def main():
    ...
    score=val['score']; decision='LIVE DASHBOARD READY' if not val['errors'] else 'LIVE DASHBOARD BLOCKED'
    ...
    ts=now_stamp(); output=MODULE_DIR/('906_live_dashboard.json'); state=MODULE_DIR/('906_live_dashboard_state_'+ts+'.json'); report=REPORTS/('906_live_dashboard_raporu_'+ts+'.txt')
