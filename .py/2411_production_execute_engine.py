...
MODULE_DIR=BASE/"production_state"/"live_production_engine"/"2411_production_execute_engine"
...
def main():
    ...
    decision="PRODUCTION EXECUTE ENGINE READY" if not v["errors"] else "PRODUCTION EXECUTE ENGINE BLOCKED"
