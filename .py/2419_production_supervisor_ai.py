...
MODULE_DIR=BASE/"production_state"/"live_production_engine"/"2419_production_supervisor_ai"
...
def main():
    ...
    decision="PRODUCTION SUPERVISOR AI READY" if not v["errors"] else "PRODUCTION SUPERVISOR AI BLOCKED"
