import argparse
from modules.neolegal_kernel_execution_engine.engine import NeolegalKernelExecutionEngineModule
def main():
    ...
    res=NeolegalKernelExecutionEngineModule().run(); r=res['result']
    print('='*80); print('305.5 NeoLegal Kernel Execution Engine'.upper()+' TAMAMLANDI'); print('='*80)
