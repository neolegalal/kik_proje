import argparse
from modules.neolegal_kernel_decision_engine.engine import NeolegalKernelDecisionEngineModule
def main():
    ...
    res=NeolegalKernelDecisionEngineModule().run(); r=res['result']
    print('='*80); print('305.8 NeoLegal Kernel Decision Engine'.upper()+' TAMAMLANDI'); print('='*80)
