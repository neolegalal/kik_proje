import argparse
from modules.neolegal_kernel_registry.engine import NeolegalKernelRegistryModule
def main():
    ...
    res=NeolegalKernelRegistryModule().run(); r=res['result']
    print('='*80); print('305.2 NeoLegal Kernel Registry'.upper()+' TAMAMLANDI'); print('='*80)
