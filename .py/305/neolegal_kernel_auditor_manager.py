import argparse
from modules.neolegal_kernel_auditor.engine import NeolegalKernelAuditorModule
def main():
    ...
    res=NeolegalKernelAuditorModule().run(); r=res['result']
    print('='*80); print('305.9 NeoLegal Kernel Auditor'.upper()+' TAMAMLANDI'); print('='*80)
