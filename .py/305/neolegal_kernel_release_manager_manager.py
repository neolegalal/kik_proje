import argparse
from modules.neolegal_kernel_release_manager.engine import NeolegalKernelReleaseManagerModule
def main():
    ...
    res=NeolegalKernelReleaseManagerModule().run(); r=res['result']
    print('='*80); print('305.10 NeoLegal Kernel Release Manager'.upper()+' TAMAMLANDI'); print('='*80)
