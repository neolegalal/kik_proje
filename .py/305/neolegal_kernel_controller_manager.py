import argparse
from modules.neolegal_kernel_controller.engine import NeolegalKernelControllerModule
def main():
    ...
    res=NeolegalKernelControllerModule().run(); r=res['result']
    print('='*80); print('305.1 NeoLegal Kernel Controller'.upper()+' TAMAMLANDI'); print('='*80)
