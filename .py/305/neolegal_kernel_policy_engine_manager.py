import argparse
from modules.neolegal_kernel_policy_engine.engine import NeolegalKernelPolicyEngineModule
def main():
    ...
    res=NeolegalKernelPolicyEngineModule().run(); r=res['result']
    print('='*80); print('305.3 NeoLegal Kernel Policy Engine'.upper()+' TAMAMLANDI'); print('='*80)
