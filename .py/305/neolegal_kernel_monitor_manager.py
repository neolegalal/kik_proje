import argparse
from modules.neolegal_kernel_monitor.engine import NeolegalKernelMonitorModule
def main():
    ...
    res=NeolegalKernelMonitorModule().run(); r=res['result']
    print('='*80); print('305.6 NeoLegal Kernel Monitor'.upper()+' TAMAMLANDI'); print('='*80)
