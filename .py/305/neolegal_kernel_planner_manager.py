import argparse
from modules.neolegal_kernel_planner.engine import NeolegalKernelPlannerModule
def main():
    ...
    res=NeolegalKernelPlannerModule().run(); r=res['result']
    print('='*80); print('305.4 NeoLegal Kernel Planner'.upper()+' TAMAMLANDI'); print('='*80)
