...
MODULE_DIR = STATE / "production_operations" / "1010_executive_control_center"
MODULE_ID = "1010"
...
def main():
    ...
    decision='EXECUTIVE CONTROL CENTER READY' if not val['errors'] else 'EXECUTIVE CONTROL CENTER BLOCKED'
    ...
    ts=now_stamp(); output=MODULE_DIR/('1010_executive_control_center.json'); state=MODULE_DIR/('1010_executive_control_center_state_'+ts+'.json'); report=REPORTS/('1010_executive_control_center_raporu_'+ts+'.txt')
