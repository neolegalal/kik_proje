import argparse
from modules.audit_intelligence_release_manager.engine import AuditIntelligenceReleaseManagerModule
def main():
    ...
    res=AuditIntelligenceReleaseManagerModule().run(); r=res['result']
    print('='*80); print('304.10 Audit Intelligence Release Manager'.upper()+' TAMAMLANDI'); print('='*80)
