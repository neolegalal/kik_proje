import argparse
from modules.audit_intelligence_decision_engine.engine import AuditIntelligenceDecisionEngineModule
def main():
    ...
    res=AuditIntelligenceDecisionEngineModule().run(); r=res['result']
    print('='*80); print('304.8 Audit Intelligence Decision Engine'.upper()+' TAMAMLANDI'); print('='*80)
