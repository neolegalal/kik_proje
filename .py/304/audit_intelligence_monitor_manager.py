import argparse
from modules.audit_intelligence_monitor.engine import AuditIntelligenceMonitorModule
def main():
    ...
    res=AuditIntelligenceMonitorModule().run(); r=res['result']
    print('='*80); print('304.6 Audit Intelligence Monitor'.upper()+' TAMAMLANDI'); print('='*80)
