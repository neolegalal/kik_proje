import argparse
from modules.audit_intelligence_controller.engine import AuditIntelligenceControllerModule
def main():
    ...
    res=AuditIntelligenceControllerModule().run(); r=res['result']
    print('='*80); print('304.1 Audit Intelligence Controller'.upper()+' TAMAMLANDI'); print('='*80)
