import argparse
from modules.audit_intelligence_execution_engine.engine import AuditIntelligenceExecutionEngineModule
def main():
    ...
    res=AuditIntelligenceExecutionEngineModule().run(); r=res['result']
    print('='*80); print('304.5 Audit Intelligence Execution Engine'.upper()+' TAMAMLANDI'); print('='*80)
