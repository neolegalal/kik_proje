import argparse
from modules.audit_intelligence_registry.engine import AuditIntelligenceRegistryModule
def main():
    ...
    res=AuditIntelligenceRegistryModule().run(); r=res['result']
    print('='*80); print('304.2 Audit Intelligence Registry'.upper()+' TAMAMLANDI'); print('='*80)
