import argparse
from modules.audit_intelligence_auditor.engine import AuditIntelligenceAuditorModule
def main():
    ...
    res=AuditIntelligenceAuditorModule().run(); r=res['result']
    print('='*80); print('304.9 Audit Intelligence Auditor'.upper()+' TAMAMLANDI'); print('='*80)
