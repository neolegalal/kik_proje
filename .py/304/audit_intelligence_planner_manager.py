import argparse
from modules.audit_intelligence_planner.engine import AuditIntelligencePlannerModule
def main():
    ...
    res=AuditIntelligencePlannerModule().run(); r=res['result']
    print('='*80); print('304.4 Audit Intelligence Planner'.upper()+' TAMAMLANDI'); print('='*80)
