import argparse
from modules.audit_intelligence_policy_engine.engine import AuditIntelligencePolicyEngineModule
def main():
    ...
    res=AuditIntelligencePolicyEngineModule().run(); r=res['result']
    print('='*80); print('304.3 Audit Intelligence Policy Engine'.upper()+' TAMAMLANDI'); print('='*80)
