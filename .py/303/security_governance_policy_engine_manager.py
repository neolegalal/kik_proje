import argparse
from modules.security_governance_policy_engine.engine import SecurityGovernancePolicyEngineModule
def main():
    ...
    res=SecurityGovernancePolicyEngineModule().run(); r=res['result']
    print('='*80); print('303.3 Security Governance Policy Engine'.upper()+' TAMAMLANDI'); print('='*80)
