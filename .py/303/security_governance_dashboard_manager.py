import argparse
from modules.security_governance_dashboard.engine import SecurityGovernanceDashboardModule
def main():
    ...
    res=SecurityGovernanceDashboardModule().run(); r=res['result']
    print('='*80); print('303.7 Security Governance Dashboard'.upper()+' TAMAMLANDI'); print('='*80)
