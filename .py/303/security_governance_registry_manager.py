import argparse
from modules.security_governance_registry.engine import SecurityGovernanceRegistryModule
def main():
    ...
    res=SecurityGovernanceRegistryModule().run(); r=res['result']
    print('='*80); print('303.2 Security Governance Registry'.upper()+' TAMAMLANDI'); print('='*80)
