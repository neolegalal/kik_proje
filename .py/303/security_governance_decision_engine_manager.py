import argparse
from modules.security_governance_decision_engine.engine import SecurityGovernanceDecisionEngineModule
def main():
    ...
    res=SecurityGovernanceDecisionEngineModule().run(); r=res['result']
    print('='*80); print('303.8 Security Governance Decision Engine'.upper()+' TAMAMLANDI'); print('='*80)
