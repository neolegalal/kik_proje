import argparse
from modules.security_governance_execution_engine.engine import SecurityGovernanceExecutionEngineModule
def main():
    ...
    res=SecurityGovernanceExecutionEngineModule().run(); r=res['result']
    print('='*80); print('303.5 Security Governance Execution Engine'.upper()+' TAMAMLANDI'); print('='*80)
