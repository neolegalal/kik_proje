import argparse
from modules.security_governance_controller.engine import SecurityGovernanceControllerModule
def main():
    ...
    res=SecurityGovernanceControllerModule().run(); r=res['result']
    print('='*80); print('303.1 Security Governance Controller'.upper()+' TAMAMLANDI'); print('='*80)
