import argparse
from modules.security_governance_monitor.engine import SecurityGovernanceMonitorModule
def main():
    ...
    res=SecurityGovernanceMonitorModule().run(); r=res['result']
    print('='*80); print('303.6 Security Governance Monitor'.upper()+' TAMAMLANDI'); print('='*80)
