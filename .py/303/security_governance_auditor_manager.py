import argparse
from modules.security_governance_auditor.engine import SecurityGovernanceAuditorModule
def main():
    ...
    res=SecurityGovernanceAuditorModule().run(); r=res['result']
    print('='*80); print('303.9 Security Governance Auditor'.upper()+' TAMAMLANDI'); print('='*80)
