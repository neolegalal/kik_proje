import argparse
from modules.security_governance_planner.engine import SecurityGovernancePlannerModule
def main():
    ...
    res=SecurityGovernancePlannerModule().run(); r=res['result']
    print('='*80); print('303.4 Security Governance Planner'.upper()+' TAMAMLANDI'); print('='*80)
