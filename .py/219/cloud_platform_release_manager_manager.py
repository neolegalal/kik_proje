import argparse
from modules.cloud_platform_release_manager.engine import CloudPlatformReleaseManagerModule
def main():
    ...
    res=CloudPlatformReleaseManagerModule().run(); r=res['result']
    print('='*80); print('219.10 Cloud Platform Release Manager'.upper()+' TAMAMLANDI'); print('='*80)
