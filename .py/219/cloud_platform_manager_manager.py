import argparse
from modules.cloud_platform_manager.engine import CloudPlatformManagerModule
def main():
    ...
    res=CloudPlatformManagerModule().run(); r=res['result']
    print('='*80); print('219.5 Cloud Platform Manager'.upper()+' TAMAMLANDI'); print('='*80)
