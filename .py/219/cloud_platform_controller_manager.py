import argparse
from modules.cloud_platform_controller.engine import CloudPlatformControllerModule
def main():
    ...
    res=CloudPlatformControllerModule().run(); r=res['result']
    print('='*80); print('219.1 Cloud Platform Controller'.upper()+' TAMAMLANDI'); print('='*80)
