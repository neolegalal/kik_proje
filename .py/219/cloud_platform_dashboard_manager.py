import argparse
from modules.cloud_platform_dashboard.engine import CloudPlatformDashboardModule
def main():
    ...
    res=CloudPlatformDashboardModule().run(); r=res['result']
    print('='*80); print('219.7 Cloud Platform Dashboard'.upper()+' TAMAMLANDI'); print('='*80)
