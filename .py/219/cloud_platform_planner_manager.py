import argparse
from modules.cloud_platform_planner.engine import CloudPlatformPlannerModule
def main():
    ...
    res=CloudPlatformPlannerModule().run(); r=res['result']
    print('='*80); print('219.3 Cloud Platform Planner'.upper()+' TAMAMLANDI'); print('='*80)
