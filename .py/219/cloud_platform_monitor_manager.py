import argparse
from modules.cloud_platform_monitor.engine import CloudPlatformMonitorModule
def main():
    ...
    res=CloudPlatformMonitorModule().run(); r=res['result']
    print('='*80); print('219.6 Cloud Platform Monitor'.upper()+' TAMAMLANDI'); print('='*80)
