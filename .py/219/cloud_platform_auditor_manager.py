import argparse
from modules.cloud_platform_auditor.engine import CloudPlatformAuditorModule
def main():
    ...
    res=CloudPlatformAuditorModule().run(); r=res['result']
    print('='*80); print('219.9 Cloud Platform Auditor'.upper()+' TAMAMLANDI'); print('='*80)
