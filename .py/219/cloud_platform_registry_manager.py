import argparse
from modules.cloud_platform_registry.engine import CloudPlatformRegistryModule
def main():
    ...
    res=CloudPlatformRegistryModule().run(); r=res['result']
    print('='*80); print('219.2 Cloud Platform Registry'.upper()+' TAMAMLANDI'); print('='*80)
