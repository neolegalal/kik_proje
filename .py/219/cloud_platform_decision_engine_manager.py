import argparse
from modules.cloud_platform_decision_engine.engine import CloudPlatformDecisionEngineModule
def main():
    ...
    res=CloudPlatformDecisionEngineModule().run(); r=res['result']
    print('='*80); print('219.8 Cloud Platform Decision Engine'.upper()+' TAMAMLANDI'); print('='*80)
