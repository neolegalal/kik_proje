...
MODULE_DIR=BASE/"production_state"/"live_production_engine"/"2418_production_scaling_engine"
...
def main():
    ...
    decision="PRODUCTION SCALING ENGINE READY" if not v["errors"] else "PRODUCTION SCALING ENGINE BLOCKED"
