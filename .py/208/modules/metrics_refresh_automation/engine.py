...
MODULE_DIR = AUTOMATION_DIR / "208_5_metrics_refresh_automation"
OUTPUT_FILE = MODULE_DIR / "208_5_metrics_refresh_automation.json"

class MetricsRefreshAutomationModule:
    def __init__(self):
        self.sdk = AutomationSDK(name="208.5 Metrics Refresh Automation")

    def analyze(self, context, plan):
        return {
            "module_id": "208.5",
            "module_name": "Metrics Refresh Automation",
    ...
    def run(self):
        ...
        result = {
            ...
            "decision": "METRICS REFRESH AUTOMATION READY" if not validation["errors"] else "METRICS REFRESH AUTOMATION REVIEW",
            "risk": context.get("risk"),
            "recommendation": plan.get("message")
        }

        payload = {
            "module": "208.5 Metrics Refresh Automation",
            "created_at": now_text(),
            "analysis": analysis,
            "result": result,
        ...
        state = STATE_DIR / f"208_5_metrics_refresh_automation_state_{ts}.json"
        report = REPORT_DIR / f"208_5_metrics_refresh_automation_raporu_{ts}.txt"
        ...
        lines = [
            "=" * 80,
            "208.5 Metrics Refresh Automation".upper(),
            "=" * 80,
