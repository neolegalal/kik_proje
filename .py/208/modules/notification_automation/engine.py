...
MODULE_DIR = AUTOMATION_DIR / "208_8_notification_automation"
OUTPUT_FILE = MODULE_DIR / "208_8_notification_automation.json"

class NotificationAutomationModule:
    def __init__(self):
        self.sdk = AutomationSDK(name="208.8 Notification Automation")

    def analyze(self, context, plan):
        return {
            "module_id": "208.8",
            "module_name": "Notification Automation",
    ...
    def run(self):
        ...
        result = {
            ...
            "decision": "NOTIFICATION AUTOMATION READY" if not validation["errors"] else "NOTIFICATION AUTOMATION REVIEW",
        ...
        state = STATE_DIR / f"208_8_notification_automation_state_{ts}.json"
        report = REPORT_DIR / f"208_8_notification_automation_raporu_{ts}.txt"
        ...
        lines = [
            "=" * 80,
            "208.8 Notification Automation".upper(),
            "=" * 80,
