...
MODULE_DIR = AUTOMATION_DIR / "208_10_automation_auditor"
OUTPUT_FILE = MODULE_DIR / "208_10_automation_auditor.json"

class AutomationAuditorModule:
    def __init__(self):
        self.sdk = AutomationSDK(name="208.10 Automation Auditor")

    def analyze(self, context, plan):
        return {
            "module_id": "208.10",
            "module_name": "Automation Auditor",
    ...
    def run(self):
        ...
        result = {
            ...
            "decision": "AUTOMATION AUDITOR READY" if not validation["errors"] else "AUTOMATION AUDITOR REVIEW",
            "risk": context.get("risk"),
            "recommendation": plan.get("message")
        }

        payload = {
            "module": "208.10 Automation Auditor",
            "created_at": now_text(),
            "analysis": analysis,
            "result": result,
        ...
        state = STATE_DIR / f"208_10_automation_auditor_state_{ts}.json"
        report = REPORT_DIR / f"208_10_automation_auditor_raporu_{ts}.txt"
        ...
        lines = [
            "=" * 80,
            "208.10 Automation Auditor".upper(),
            "=" * 80,
