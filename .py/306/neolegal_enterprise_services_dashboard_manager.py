import argparse
from modules.neolegal_enterprise_services_dashboard.engine import NeolegalEnterpriseServicesDashboardModule
def main():
    ...
    res=NeolegalEnterpriseServicesDashboardModule().run(); r=res['result']
    print('='*80); print('306.7 NeoLegal Enterprise Services Dashboard'.upper()+' TAMAMLANDI'); print('='*80)
