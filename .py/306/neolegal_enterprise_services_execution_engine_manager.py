import argparse
from modules.neolegal_enterprise_services_execution_engine.engine import NeolegalEnterpriseServicesExecutionEngineModule
def main():
    ...
    res=NeolegalEnterpriseServicesExecutionEngineModule().run(); r=res['result']
    print('='*80); print('306.5 NeoLegal Enterprise Services Execution Engine'.upper()+' TAMAMLANDI'); print('='*80)
