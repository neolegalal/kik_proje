...
def main():
    ...
    res=NeolegalEnterpriseServicesSDK().run(); v=res['payload']['validation']; p=res['payload']['plan']
    print('='*80); print('306.0 NeoLegal Enterprise Services SDK TAMAMLANDI'.upper()); print('='*80)
