import argparse
from modules.neolegal_enterprise_services_controller.engine import NeolegalEnterpriseServicesControllerModule
def main():
    ...
    res=NeolegalEnterpriseServicesControllerModule().run(); r=res['result']
    print('='*80); print('306.1 NeoLegal Enterprise Services Controller'.upper()+' TAMAMLANDI'); print('='*80)
