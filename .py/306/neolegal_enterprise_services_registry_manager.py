import argparse
from modules.neolegal_enterprise_services_registry.engine import NeolegalEnterpriseServicesRegistryModule
def main():
    ...
    res=NeolegalEnterpriseServicesRegistryModule().run(); r=res['result']
    print('='*80); print('306.2 NeoLegal Enterprise Services Registry'.upper()+' TAMAMLANDI'); print('='*80)
