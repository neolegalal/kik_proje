import argparse
from modules.neolegal_enterprise_services_monitor.engine import NeolegalEnterpriseServicesMonitorModule
def main():
    ...
    res=NeolegalEnterpriseServicesMonitorModule().run(); r=res['result']
    print('='*80); print('306.6 NeoLegal Enterprise Services Monitor'.upper()+' TAMAMLANDI'); print('='*80)
