import argparse
from modules.neolegal_api_gateway_release_manager.engine import NeolegalApiGatewayReleaseManagerModule
def main():
    ...
    res=NeolegalApiGatewayReleaseManagerModule().run(); r=res['result']
    print('='*80); print('308.10 NeoLegal API Gateway Release Manager'.upper()+' TAMAMLANDI'); print('='*80)
