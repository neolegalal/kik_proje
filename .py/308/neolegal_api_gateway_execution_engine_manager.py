import argparse
from modules.neolegal_api_gateway_execution_engine.engine import NeolegalApiGatewayExecutionEngineModule
def main():
    ...
    res=NeolegalApiGatewayExecutionEngineModule().run(); r=res['result']
    print('='*80); print('308.5 NeoLegal API Gateway Execution Engine'.upper()+' TAMAMLANDI'); print('='*80)
