import argparse
from modules.neolegal_api_gateway_registry.engine import NeolegalApiGatewayRegistryModule
def main():
    ...
    res=NeolegalApiGatewayRegistryModule().run(); r=res['result']
    print('='*80); print('308.2 NeoLegal API Gateway Registry'.upper()+' TAMAMLANDI'); print('='*80)
