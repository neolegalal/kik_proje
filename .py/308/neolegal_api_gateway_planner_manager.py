import argparse
from modules.neolegal_api_gateway_planner.engine import NeolegalApiGatewayPlannerModule
def main():
    ...
    res=NeolegalApiGatewayPlannerModule().run(); r=res['result']
    print('='*80); print('308.4 NeoLegal API Gateway Planner'.upper()+' TAMAMLANDI'); print('='*80)
