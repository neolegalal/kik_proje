import argparse
from modules.neolegal_api_gateway_policy_engine.engine import NeolegalApiGatewayPolicyEngineModule
def main():
    ...
    res=NeolegalApiGatewayPolicyEngineModule().run(); r=res['result']
    print('='*80); print('308.3 NeoLegal API Gateway Policy Engine'.upper()+' TAMAMLANDI'); print('='*80)
