import argparse
from modules.neolegal_api_gateway_controller.engine import NeolegalApiGatewayControllerModule
def main():
    ...
    res=NeolegalApiGatewayControllerModule().run(); r=res['result']
    print('='*80); print('308.1 NeoLegal API Gateway Controller'.upper()+' TAMAMLANDI'); print('='*80)
