import argparse
from modules.neolegal_api_gateway_monitor.engine import NeolegalApiGatewayMonitorModule
def main():
    ...
    res=NeolegalApiGatewayMonitorModule().run(); r=res['result']
    print('='*80); print('308.6 NeoLegal API Gateway Monitor'.upper()+' TAMAMLANDI'); print('='*80)
