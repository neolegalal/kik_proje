import argparse
from modules.neolegal_platform_os_monitor.engine import NeolegalPlatformOsMonitorModule
def main():
    ...
    res=NeolegalPlatformOsMonitorModule().run(); r=res['result']
    print('='*80); print('309.6 NeoLegal Platform OS Monitor'.upper()+' TAMAMLANDI'); print('='*80)
