import argparse
from modules.neolegal_platform_os_controller.engine import NeolegalPlatformOsControllerModule
def main():
    ...
    res=NeolegalPlatformOsControllerModule().run(); r=res['result']
    print('='*80); print('309.1 NeoLegal Platform OS Controller'.upper()+' TAMAMLANDI'); print('='*80)
