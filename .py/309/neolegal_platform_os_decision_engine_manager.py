import argparse
from modules.neolegal_platform_os_decision_engine.engine import NeolegalPlatformOsDecisionEngineModule
def main():
    ...
    res=NeolegalPlatformOsDecisionEngineModule().run(); r=res['result']
    print('='*80); print('309.8 NeoLegal Platform OS Decision Engine'.upper()+' TAMAMLANDI'); print('='*80)
