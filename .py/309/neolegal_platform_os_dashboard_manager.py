import argparse
from modules.neolegal_platform_os_dashboard.engine import NeolegalPlatformOsDashboardModule
def main():
    ...
    res=NeolegalPlatformOsDashboardModule().run(); r=res['result']
    print('='*80); print('309.7 NeoLegal Platform OS Dashboard'.upper()+' TAMAMLANDI'); print('='*80)
