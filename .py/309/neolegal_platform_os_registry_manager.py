import argparse
from modules.neolegal_platform_os_registry.engine import NeolegalPlatformOsRegistryModule
def main():
    ...
    res=NeolegalPlatformOsRegistryModule().run(); r=res['result']
    print('='*80); print('309.2 NeoLegal Platform OS Registry'.upper()+' TAMAMLANDI'); print('='*80)
