import argparse
from modules.neolegal_platform_os_auditor.engine import NeolegalPlatformOsAuditorModule
def main():
    ...
    res=NeolegalPlatformOsAuditorModule().run(); r=res['result']
    print('='*80); print('309.9 NeoLegal Platform OS Auditor'.upper()+' TAMAMLANDI'); print('='*80)
