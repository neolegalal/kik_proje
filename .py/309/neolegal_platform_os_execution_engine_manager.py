import argparse
from modules.neolegal_platform_os_execution_engine.engine import NeolegalPlatformOsExecutionEngineModule
def main():
    ...
    res=NeolegalPlatformOsExecutionEngineModule().run(); r=res['result']
    print('='*80); print('309.5 NeoLegal Platform OS Execution Engine'.upper()+' TAMAMLANDI'); print('='*80)
