...
MODULE_DIR=BASE/"production_state"/"live_production_engine"/"2415_production_auto_publisher"
...
def main():
    ...
    decision="PRODUCTION AUTO PUBLISHER READY" if not v["errors"] else "PRODUCTION AUTO PUBLISHER BLOCKED"
