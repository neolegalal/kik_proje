...
LAYER_ID = "304"
LAYER_NAME = "Audit Intelligence"
COMMANDS = [
    ("304_AuditIntelligence_SDK.py", [sys.executable, str(BASE / ".py" / "304_AuditIntelligence_SDK.py"), "--test"]),
    ("304_1_AuditIntelligenceController.py", [sys.executable, str(BASE / ".py" / "304_1_AuditIntelligenceController.py"), "--run"]),
    ("304_2_AuditIntelligenceRegistry.py", [sys.executable, str(BASE / ".py" / "304_2_AuditIntelligenceRegistry.py"), "--run"]),
    ("304_3_AuditIntelligencePolicyEngine.py", [sys.executable, str(BASE / ".py" / "304_3_AuditIntelligencePolicyEngine.py"), "--run"]),
    ("304_4_AuditIntelligencePlanner.py", [sys.executable, str(BASE / ".py" / "304_4_AuditIntelligencePlanner.py"), "--run"]),
    ("304_5_AuditIntelligenceExecutionEngine.py", [sys.executable, str(BASE / ".py" / "304_5_AuditIntelligenceExecutionEngine.py"), "--run"]),
    ("304_6_AuditIntelligenceMonitor.py", [sys.executable, str(BASE / ".py" / "304_6_AuditIntelligenceMonitor.py"), "--run"]),
    ("304_7_AuditIntelligenceDashboard.py", [sys.executable, str(BASE / ".py" / "304_7_AuditIntelligenceDashboard.py"), "--run"]),
    ("304_8_AuditIntelligenceDecisionEngine.py", [sys.executable, str(BASE / ".py" / "304_8_AuditIntelligenceDecisionEngine.py"), "--run"]),
    ("304_9_AuditIntelligenceAuditor.py", [sys.executable, str(BASE / ".py" / "304_9_AuditIntelligenceAuditor.py"), "--run"]),
    ("304_10_AuditIntelligenceReleaseManager.py", [sys.executable, str(BASE / ".py" / "304_10_AuditIntelligenceReleaseManager.py"), "--run"]),
]
