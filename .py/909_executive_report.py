...
MODULE_DIR = STATE / "production_master" / "909_executive_report"
MODULE_ID = "909"
MODULE_NAME = "Executive Report"
...
def main():
    ...
    score=val['score']; decision='EXECUTIVE REPORT READY' if not val['errors'] else 'EXECUTIVE REPORT BLOCKED'
    ...
    ts=now_stamp(); output=MODULE_DIR/('909_executive_report.json'); state=MODULE_DIR/('909_executive_report_state_'+ts+'.json'); report=REPORTS/('909_executive_report_raporu_'+ts+'.txt')
