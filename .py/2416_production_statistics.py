...
MODULE_DIR=BASE/"production_state"/"live_production_engine"/"2416_production_statistics"
...
def main():
    ...
    decision="PRODUCTION STATISTICS READY" if not v["errors"] else "PRODUCTION STATISTICS BLOCKED"
